...
<body>
	...
	$sql = "SELECT nom,description,prix,taille, couleur FROM articles WHERE categorie='Vetements' AND sous_cat='Hauts' AND sexe='H' GROUP BY nom";
	...
	{	
		...
		echo '<div id="photo1"><img src="Images/Hommes/Hauts/haut1.jpg" width="130" height="170"/></div>';
		echo '<div id="infos">
				<div id="gauche">
					<h2>'.$nom.'</h2>
