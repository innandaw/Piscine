...
<body>
	...
	$sql = "SELECT nom,description,prix,taille,photos,couleur, id FROM articles WHERE categorie='Musique' AND sous_cat='musique_class' GROUP BY nom";
	$sql = "SELECT nom,description,prix,taille,photos,couleur, id FROM articles WHERE categorie='Musique' AND sous_cat='classique' GROUP BY nom";
