...
<body>
	...
	<h1 id="titre">Chaussures Hommes</h1>
	...
	$sql = "SELECT nom,description,prix,taille, photos,couleur, id FROM articles WHERE categorie='Vetements' AND sous_cat='Chaussures' AND sexe='H' GROUP BY nom";
    ...
    $fichier_dossier = 'Images/Hommes/Chaussures/';
		...
		echo '<div id="cadre1">
			...
			echo '<div id="gauche">
				<div id="'.$id.'">
					...
					{
						$taille=$row1["taille"];
						echo '<div id="sizes"><a href ="chaussuresHommes.php?tail='.$taille.'&coul=0#'.$id.'"><h3 class="infos2"> '.$taille.'</h3></a></div>';				
					}
					...
					while ($row1 = mysqli_fetch_assoc($result1)) 
					{
						...
						echo '<div id="color"><a href ="chaussuresHommes.php?tail='.$taille.'&coul='.$couleur.'#'.$id.'"><h3 class="infos2">'.$couleur.'</h3></a></div>';				
					}
