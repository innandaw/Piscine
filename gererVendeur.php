...
<body>
	...
	<div id="cadre">
		...
		$sql = "SELECT mail,nom,description,prix,taille,photos,couleur FROM personnes WHERE statut='V'";
		...
		{	
			...
			echo '<a href ="supprArticle.php?idArticle='.$id.'"><div id="decon"><input type="button" id="deconnecte" width="42px" height="45px"></div></a>';
