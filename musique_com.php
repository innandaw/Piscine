...
<<<<<<< HEAD
	$sql = "SELECT nom,description,prix,taille,photos,couleur, id FROM articles WHERE categorie='Musique' AND sous_cat='musique_com' GROUP BY nom";
=======
	$sql = "SELECT nom,description,prix,taille,photos,couleur, id FROM articles WHERE categorie='Musique' AND sous_cat='commerciale' GROUP BY nom";
>>>>>>> footer
    ...
    $fichier_dossier = 'Images/musique/';
